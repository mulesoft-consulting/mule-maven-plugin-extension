...
public class ExchangeDeployer implements Deployer {
  ...
  public ExchangeDeployer(Deployment deployment, DeployerLog log) throws DeploymentException {
    this(getDeployerFactory(deployment).createArtifactDeployer(deployment, log), deployment.getApplicationName(), log);
  }

  public ExchangeDeployer(Deployer deployer, String applicationName, DeployerLog log) {
