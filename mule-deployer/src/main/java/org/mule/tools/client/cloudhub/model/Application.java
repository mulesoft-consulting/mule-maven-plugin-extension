...
public class Application {
  ...
  private Map<String, String> applicationSource;
  private Map<String, Object> applicationInfo;
  private Boolean autoStart;

  private String region;
  private transient Workers workers;
  ...
  public Map<String, String> getApplicationSource() {
    return applicationSource;
  }

  public void setApplicationSource(Map<String, String> applicationSource) {
