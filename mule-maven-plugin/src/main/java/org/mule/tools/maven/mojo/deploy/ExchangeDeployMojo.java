 ...
 * @since 1.0
 */
@Mojo(name = "deploy-exchange", requiresProject = true)
public class ExchangeDeployMojo extends AbstractMuleDeployerMojo {
  ...
  public void doExecute() throws MojoFailureException, MojoExecutionException {
    log.info("ESTOY EN EL EXCHANGE DEPLOY MOJOOOOO");
    try {
